...
/*---------------Fish Haven--------------------------------------------*/
    ...
    founded.textContent = "Year Founded: " + towns[2].yearFounded;
    card.appendChild(founded);

    let population = document.createElement('p');
    population.textContent = "Current Population: " + towns[2].currentPopulation;
    card.appendChild(population);

    let rain = document.createElement('p');
    rain.textContent = "Average Yearly Rainfall: " + towns[2].averageRainfall + " inches";
...
/*-------------------PRESTON----------------------------------*/
    ...
    population2.textContent = "Current Population: " + towns[6].currentPopulation;
    card2.appendChild(population2);

    let rain2 = document.createElement('p');
    rain2.textContent = "Average Yearly Rainfall: " + towns[6].averageRainfall + " inches";
